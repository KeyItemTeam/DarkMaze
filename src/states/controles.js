...
DarkMaze.controlesState.prototype = {
    ...
    create: function() {
        ...
        var texto = game.add.text(50, 150, 'Minotauro: mov con flechas, correr SHIFT, antorcha P, romper roca y atrapar SPACE.', {font: '13px Courier', fill: '#ffffff'});
        var texto = game.add.text(50, 170, 'Teseo: mov con WASD, correr O, roca Q.', {font: '13px Courier', fill: '#ffffff'});

        var texto = game.add.text(50, 200, 'Durante la segunda ronda:', {font: '20px Courier', fill: '#c6f9ac'});
        var texto = game.add.text(50, 250, 'Minotauro: mov con WASD, correr O, antorcha P, romper roca y atrapar SPACE.', {font: '13px Courier', fill: '#ffffff'});
        var texto = game.add.text(50, 270, 'Teseo: mov con flechas, correr SHIFT, roca Q.', {font: '13px Courier', fill: '#ffffff'});
