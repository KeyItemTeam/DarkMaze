    ...
    create: function () {
        ...
        this.getPlayer(function (player2Data) {
            ...
            if (player2Data.type == "TESEO") {
                ...
                game.player2.animations.add('idle', [0, 1, 2, 3], 6, true);
                game.player2.animations.add('idleBack', [4, 5, 6, 7], 6, true);
                game.player2.animations.add('idleLeft', [8, 9, 10, 11], 6, true);
                game.player2.animations.add('idleRight', [12, 13, 14, 15], 6, true);
                game.player2.animations.add('walk', [16, 17, 18, 19, 20, 21, 22, 23], 12, true);
                game.player2.animations.add('walkBack', [24, 25, 26, 27, 28, 29, 30, 31], 12, true);
                game.player2.animations.add('walkLeft', [32, 33, 34, 35, 36, 37, 38, 39], 12, true);
                game.player2.animations.add('walkRight', [40, 41, 42, 43, 44, 45, 46, 47], 12, true);
                game.player2.animations.play("idle");
                game.physics.enable(game.player2, Phaser.Physics.ARCADE);
                game.player2.anchor.setTo(0.5);
                game.player2.body.setSize(24, 24, 20, 30);
                game.player2.direction = 1;
                game.player2.run = 100;
                game.player2.speed = 100;
                ...
                game.player2.animations.add('walkLeft', [32, 33, 34, 35, 36, 37, 38, 39], 12, true);
                game.player2.animations.add('walkRight', [40, 41, 42, 43, 44, 45, 46, 47], 12, true);
                game.player2.animations.add('attack', [48, 49, 50, 51], 9, true);
                game.player2.animations.add('attackBack', [52, 53, 54, 55], 9, true);
                game.player2.animations.add('attackLeft', [56, 57, 58, 59], 9, true);
                game.player2.animations.add('attackRight', [60, 61, 62, 63], 9, true);
                game.player2.animations.play("idle");
                game.physics.enable(game.player2, Phaser.Physics.ARCADE);
                game.player2.anchor.setTo(0.5);
                game.player2.body.setSize(24, 24, 20, 30);
        ...
        if (game.player1.type == "MINOTAURO") {
            ...
            game.player1.animations.add('idle', [0, 1, 2, 3], 6, true);
            game.player1.animations.add('idleBack', [4, 5, 6, 7], 6, true);
            game.player1.animations.add('idleLeft', [8, 9, 10, 11], 6, true);
            game.player1.animations.add('idleRight', [12, 13, 14, 15], 6, true);
            game.player1.animations.add('walk', [16, 17, 18, 19, 20, 21, 22, 23], 12, true);
            game.player1.animations.add('walkBack', [24, 25, 26, 27, 28, 29, 30, 31], 12, true);
            game.player1.animations.add('walkLeft', [32, 33, 34, 35, 36, 37, 38, 39], 12, true);
            game.player1.animations.add('walkRight', [40, 41, 42, 43, 44, 45, 46, 47], 12, true);
            game.player1.animations.add('attack', [48, 49, 50, 51], 9, true);
            game.player1.animations.add('attackBack', [52, 53, 54, 55], 9, true);
            game.player1.animations.add('attackLeft', [56, 57, 58, 59], 9, true);
            game.player1.animations.add('attackRight', [60, 61, 62, 63], 9, true);
            game.player1.animations.play("idle");
            game.physics.enable(game.player1, Phaser.Physics.ARCADE);
            game.player1.anchor.setTo(0.5);
            game.player1.body.setSize(24, 24, 20, 30);
            game.player1.direction = 1;
            game.player1.run = 100;
            game.player1.speed = 100;
