...
DarkMaze.menuppalState.prototype = {
	...
	create: function () {
		...
		game.add.text(100, 100, 'Dark Maze', {
			font: '50px Courier',
			fill: '#c6f9ac'
		});
		game.add.text(150, 150, 'Un juego hecho por Key Item Team', {
			font: '15px Courier',
			fill: '#ffffff'
		});
		game.add.text(100, 320,
			'[DEBUG] Pulsa A para acceder al menú de selección de equipos',
			{
				font: '13px Courier',
				fill: '#ffffff'
			});
